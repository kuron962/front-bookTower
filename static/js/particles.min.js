...
var pJS = function (e, a) {
  if (this.isClient) {
    ...
    a && Object.deepExtend(i, a),
      ...
      (i.fn.retinaInit = function () {
        i.retina_detect && globalThis.window.devicePixelRatio > 1
          ? ((i.canvas.pxratio = globalThis.window.devicePixelRatio),
            (i.tmp.retina = !0))
      ...
      (i.fn.vendors.eventsListeners = function () {
        "globalThis.window" == i.interactivity.detect_on
          ? (i.interactivity.el = globalThis.window)
          : (i.interactivity.el = i.canvas.el),
          (i.interactivity.events.onhover.enable ||
            i.interactivity.events.onclick.enable) &&
            (i.interactivity.el.addEventListener("mousemove", function (e) {
              if (i.interactivity.el == globalThis.window)
                var a = e.clientX,
                  t = e.clientY;
              else
      ...
      (i.fn.vendors.exportImg = function () {
        globalThis.window.open(i.canvas.el.toDataURL("image/png"), "_blank");
      }),
  ...
  (Object.deepExtend = function (e, a) {
    ...
    (globalThis.window.requestAnimFrame = (function () {
      return (
        ...
        function (e) {
          globalThis.window.setTimeout(e, 1e3 / 60);
        }
      );
    })()),
    (globalThis.window.cancelRequestAnimFrame = (function () {
      return (
        globalThis.window.cancelAnimationFrame ||
        globalThis.window.webkitCancelRequestAnimationFrame ||
        globalThis.window.mozCancelRequestAnimationFrame ||
        globalThis.window.oCancelRequestAnimationFrame ||
        globalThis.window.msCancelRequestAnimationFrame ||
        clearTimeout
      );
    })()),
    (globalThis.window.pJSDom = []),
    (globalThis.window.particlesJS = function (e, a) {
    ...
    (globalThis.window.particlesJS.load = function (e, a, t) {
        ...
        (i.onreadystatechange = function (a) {
          if (4 == i.readyState)
            if (200 == i.status) {
              ...
              globalThis.window.particlesJS(e, s), t && t();
            } else
